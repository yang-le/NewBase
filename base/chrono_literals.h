...
inline namespace literals {
    inline namespace chrono_literals {
        inline std::chrono::hours operator "" _h(unsigned long long val)
        ...
        inline std::chrono::minutes operator "" _min(unsigned long long val)
        ...
        inline std::chrono::seconds operator "" _s(unsigned long long val)
        ...
        inline std::chrono::milliseconds operator "" _ms(unsigned long long val)
        ...
        inline std::chrono::microseconds operator "" _us(unsigned long long val)
        ...
        inline std::chrono::nanoseconds operator "" _ns(unsigned long long val)
